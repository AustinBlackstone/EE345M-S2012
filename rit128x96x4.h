...
//Extras for EE345M
#define	top		1		  //OLED Message
#define	bottom 	0		  //OLED Message
...
// Input: string, value, 
// Return: none
// outputs String then Value appended, max 21 characters total per line, flows bottom up
//
//Errors: doesnt accept more than 21chars, will return error message instead "ERR"
